...
const unsigned long PLAY_SHORT_TUNE_BEFORE_TIMEPASSED_MS = 60000;
...
const char m_MASH[] PROGMEM = "d=8,o=5,b=140:4a,4g,f#,g,p,f#,p,g,p,f#,p,2e.,p,f#,e,4f#,e,f#,p,e,p,4d.,p,f#,4e,d,e,p,d,p,e,p,d,p,2c#.,p,d,c#,4d,c#,d,p,e,p,4f#,p,a,p,4b,a,b,p,a,p,b,p,2a.,4p,a,b,a,4b,a,b,p,2a.,a,4f#,a,b,p,d6,p,4e.6,d6,b,p,a,p,2b";
...
const char m_GoodBad[] PROGMEM = "d=4,o=5,b=56:32p,32a#,32d#6,32a#,32d#6,8a#.,16f#.,16g#.,d#,32a#,32d#6,32a#,32d#6,8a#.,16f#.,16g#.,c#6,32a#,32d#6,32a#,32d#6,8a#.,16f#.,32f.,32d#.,c#,32a#,32d#6,32a#,32d#6,8a#.,16g#.,d#";
...
const char m_MahnaMahna[] PROGMEM = "d=16,o=6,b=125:c#,c.,b5,8a#.5,8f.,4g#,a#,g.,4d#,8p,c#,c.,b5,8a#.5,8f.,g#.,8a#.,4g,8p,c#,c.,b5,8a#.5,8f.,4g#,f,g.,8d#.,f,g.,8d#.,f,8g,8d#.,f,8g,d#,8c,a#5,8d#.,8d#.,4d#,8d#.";
const char m_LeisureSuit[] PROGMEM = "d=16,o=6,b=56:f.5,f#.5,g.5,g#5,32a#5,f5,g#.5,a#.5,32f5,g#5,32a#5,g#5,8c#.,a#5,32c#,a5,a#.5,c#.,32a5,a#5,32c#,d#,8e,c#.,f.,f.,f.,f.,f,32e,d#,8d,a#.5,e,32f,e,32f,c#,d#.,c#";
...
const char* melodies[] = {
  m_TheSimpsons, m_Indiana, m_TakeOnMe, m_Entertainer, m_Muppets, m_Xfiles, m_Looney, m_20thCenFox,
  m_Bond, m_MASH, m_StarWars, m_GoodBad, m_TopGun, m_ATeam, m_Flinstones,
  m_Jeopardy, m_Gadget, m_Smurfs, m_MahnaMahna, m_LeisureSuit, m_MissionImp
};
...
bool play_rtttl(char *p, int limit)
{
  ...
  unsigned long limitTimeMs = limit >= 1000 ? limit : 0;
  int limitNotes = limit < 1000 ? limit : 0;

  unsigned long playedTimeStartMs = millis();
  int playedNotes = 0;
