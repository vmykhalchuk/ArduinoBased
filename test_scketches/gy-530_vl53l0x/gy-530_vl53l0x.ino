...
void loop() {
  Serial.println("Dist\tAmbCnt\tSigCnt\tStatus");
...
void readAndPrintDistance() {
  ...
  if (!(val & 0x01)) { Serial.println("ERROR"); return; }
  ...
  Serial.print(acnt); Serial.print("\t");
  Serial.print(scnt); Serial.print("\t");
  Serial.print(DeviceRangeStatusInternal); Serial.println();
